...
void getFilters(vector<Filter*>& filters)
{
	...
	filter = (Filter*)(new NegateFilter(new ContainsFilter("CC", "ceng.metu.edu.tr")));
	...
	filter = (new CompositeFilter(CompositeFilter::ALL))->
		...
		addFilter((Filter*)(new NegateFilter(new ContainsFilter("Body", "Hacettepe"))));
	...
	filter = (new CompositeFilter(CompositeFilter::ALL))->
		...
		addFilter((new CompositeFilter(CompositeFilter::NONE))->
					...
					addFilter((Filter*)(new NegateFilter(new EqualsFilter("Subject", "(No subject)")))));
	...
	filter = (new CompositeFilter(CompositeFilter::ALL))->
		...
		addFilter((Filter*)(new NegateFilter(new EqualsFilter("From", "user"))));
